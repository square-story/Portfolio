...
export const DATA = {
  ...
  description:
    "An MERN Stack Developer with expertise in building responsive and scalable web applications.",
  summary:
  ...
  contact: {
    ...
    social: {
      ...
      email: {
        name: "Send Email",
        url: "https://mail.google.com/mail/u/0/?fs=1&to=shasadik3@gmail.com&su=FROM_PORTFOLIO&body=BODY&tf=cm",
        icon: Icons.email,
