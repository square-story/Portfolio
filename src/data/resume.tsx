...
export const DATA = {
  ...
  summary:
    "MERN stack developer with a background in accounting, now focused on building clean, scalable web apps with strong user experience. Started from spreadsheets, grew through self-driven learning, and [now crafting real-world solutions with code](#projects). Passionate about continuous improvement and [delivering value through technology](#skills).",
  avatarUrl: "/me.jpg",
  skills: [
